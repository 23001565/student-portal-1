  ...
  const onFileSelected = async (f) => {
    ...
    try {
      ...
      setMapping((m) => ({
        programId:
          m.programId ||
          r[0][lower.indexOf("programid")] ||
          r[0][lower.indexOf("ctdtid")] ||
          "",
        programName:
          m.programName ||
          r[0][lower.indexOf("programname")] ||
          r[0][lower.indexOf("tenctdt")] ||
          "",
        courseCode:
          m.courseCode ||
        ...
        courseName:
          m.courseName ||
          r[0][lower.indexOf("coursename")] ||
          r[0][lower.indexOf("tenmh")] ||
          "",
        credits:
          m.credits ||
          r[0][lower.indexOf("credits")] ||
          r[0][lower.indexOf("sotinchi")] ||
          "",
        term:
          m.term ||
        ...
        prerequisites:
          m.prerequisites ||
          r[0][lower.indexOf("prerequisites")] ||
          r[0][lower.indexOf("tienquyet")] ||
          "",
      }));
    } catch (e) {
      console.error(e);
